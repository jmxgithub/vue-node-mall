    ...
    <div class="container">
            ...
            <ul class="cart-item-list">
                ...
                <div class="cart-tab-1">
                    <div class="cart-item-pic">
                        <img v-bind:src="'./static/'+ item.productImage" v-bind:alt="item.userName">
                    </div>
        ...
        <div class="order-foot-wrap">
            ...
            <div class="next-btn-wrap">
                <button class="btn btn--m btn--red" v-bind:class="{'btn--dis': cartList.length == 0}" @click="payment">Proceed to payment</button>
            </div>
        </div>
        </div>
    </div>
