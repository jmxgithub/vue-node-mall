<template>
    <div>
      ...
      <div class="accessory-result-page accessory-page">
        <div class="container">
          <div class="filter-nav">
            ...
            <a href="javascript:void(0)" class="price" @click="sortGoods">Price <svg class="icon icon-arrow-short" v-bind:class="{'sort-up':sortFlag}"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow-short"></use></svg></a>
      ...
      <Modal v-bind:mdShow="mdShow" @close="closeModal" >
          <p slot="md-content">请先登陆，否则无法加入购物车</p>
          <div slot="btnGroup">
            ...
            addCart (productId) {
                axios.post("/goods/addCart", {productId: productId}).then((result) => {
                    ...
                    if (res.status == "0"){
                        ...
                        this.$store.commit('updatedCartCount', 1);
                    } else {
                        this.mdShow = true;
                    }
                })
