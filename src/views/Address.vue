      ...
      <div class="checkout-page">
        ...
        <div class="container">
            ...
            <div class="addr-list-wrap">
                ...
                <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand" v-bind:class="{open: addressList.length == limit}">
                    more
                    <i class="i-up-down">
        ...
        methods: {
            ...
            getAddressList() {
                axios.get('/users/addressList').then((result) => {
                    let res = result.data;
                    if (res.status == "0") {
                        res.result.addressList.forEach((item, index) => {
                            if (item.isDefault) {
                                this.selectedAddressId = item.addressId;
                                this.checkIndex = 0;
                                let obj = res.result.addressList.splice(index, 1);
                                res.result.addressList.unshift(obj[0]);
                            }
                        })
